...
Given that some of the titles in the wikipedia articles contain non-ASCII characters, we provide an automated solution where each time article information is retrieved from the web, we convert everything to ASCII characters. 
